...
if __name__ == "__main__":
    ...
    with open(result_path_data + "/Constrained_DQN_"+str(result_round)+".json", "w") as f:
        json.dump(results, f)
    with open(result_path_testing + "/Constrained_DQN_testing_"+str(result_round)+".json", "w") as f:
        json.dump(dqn_agent.testing_monitor, f)
